...
window.BRANCH_LOCAL_CARDS  = [
  {
    ...
    scheduleTable: [
      ...
      { zone: "Machias territory", zoneClass: "machias", towns: "See purple areas on map (Machias delivery territory)", routedToBranch: "machias", routedSearchTerm: "delivery" }
    ],
    workflowSteps: [
      {
        type: "routine",
...
window.BRANCH_SUPPRESS     = ["general-placeholder"];
